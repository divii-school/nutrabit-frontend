        ...
        <div class="p-col-12">
            <div class="card p-fluid">
                ...
                <div class="p-field p-grid">
                    <label for="business_name" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">신청자명 / 업체명:</label>

                    <div class="p-col-12 p-md-10" style="display: flex; justify-content: space-between">
                        <p v-if="business_name != null">{{ business_name }}</p>
                        <p v-else>{{ applicant_name }}</p>
                ...
                <div class="p-field p-grid">
                    <label for="title" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">문의 제목:</label>
                ...
                <div class="p-field p-grid">
                    <label for="title" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">문의:</label>
                    <div class="p-col-12 p-md-10">
                        <p>{{ description }}</p>
                    </div>
                </div>
                ...
                <div class="p-field p-grid">
                    <label for="title" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">첨부 파일:</label>
            ...
            <div class="card p-fluid" >
                ...
                <div class="p-grid p-formgrid p-mb-3">
                    <div class="p-col-12 p-mb-2 p-lg-6 p-mb-lg-0 p-field">
                        ...
                        <div>
                            <input type="radio" id="Korean" name="replyLang" value="ko" v-model="replyLang"  />
...
export default {
    ...
    mounted() {
        ...
        this.inquiryService.viewInquiry(this.$route.params.id).then((res) => {
            ...
            this.replyText = res.data.data[0].replyText;
            this.replyLang = res.data.data[0].replyLang;
