            ...
            <div class="card p-fluid">
                ...
                <div class="p-formgrid p-grid">
                        <div class="p-field p-col-12 p-md-4">
                            ...
                            <InputText id="googlurl" type="text" placeholder="input text" v-model="title" />
                        </div>
                        <div class="p-field p-col-12 p-md-4">
                            <label for="type">{{ $t('Inquiry.list.appname') }}</label>
                            <!-- <label for="type">ID</label> -->
                            <select class="p-dropdown-label p-inputtext" name="business_name" id="business_name" v-model="name">
                            <option value="">Select</option>
                            <option v-for="(item , index) in businessDropdownValues" v-bind:key="index" :value="item.id" >
                            {{item.business_name}}
                            </option>
                            </select>
                    ...
                    <div class="p-field p-col-12 p-md-4">
                            ...
                            <option value="">Select</option>
                            <option v-for="(statusitem , index) in statusDropdownValues" v-bind:key="index" :value="statusitem.id" >
                            {{statusitem.status}}
                            </option>
                            </select>
                           <!-- <Dropdown v-model="id"  :options="dropdownValues"  optionLabel="category_name_ko" :placeholder="$t('Banner.placeholder.select')" /> -->
        ...
        <div class="p-col-12" v-show="clientlist">
            <div class="card">
                ...
                <DataTable :value="customer1" :paginator="true" class="p-datatable-gridlines" :rows="5" dataKey="id" :rowHover="true" :loading="loading1" :filters="filters1" responsiveLayout="scroll" style="text-align: center">
                    ...
                    <Column field="ReferralCode" :header="$t('Inquiry.list.title')" style="min-width: 12rem">
                        <template #body="{ data }">
                     ...
                     <Column :header="$t('Inquiry.list.QuestionType')" style="min-width: 12rem">
                        <template #body="{ data }">
                    ...
                    <Column :header="$t('Inquiry.list.appname')" style="min-width: 12rem">
                     ...
                     <Column :header="$t('Inquiry.list.inqurydate')" style="min-width: 12rem">
                        <template #body="{ data }">
                    ...
                    <Column field="Exposure" :header="$t('Inquiry.list.status')" style="min-width: 12rem">
                            <template #body="{ data }">
                        ...
                        <template #body="{ data }">
                            ...
                            <div style="display: flex">
                                ...
                                <router-link :to="'/reply-inquiry/' + data.id"
                                    ><Button label="help" class="p-button-outlined p-button-help p-mr-2 p-mb-2"><i class="pi pi-reply p-mr-2"></i></Button></router-link
                                >
