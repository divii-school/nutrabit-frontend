...
const validateEditCategory = (data) => {
    ...
    const {scnd_category_name_ko,scnd_category_name_en,file} = data;
    ...
    if (validator.isEmpty(scnd_category_name_ko)) {
        errors.scnd_category_name_ko = 'URL을 입력해주세요';
    }
    if (validator.isEmpty(scnd_category_name_en)) {
        errors.scnd_category_name_en = '유효하지 않은 URL입니다';
    }
...
export default validateEditCategory;