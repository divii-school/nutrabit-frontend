...
const validateEditPackage = (data) => {
  let errors = {}
  
  const { name_ko,name_en,description_ko,description_en} = data;
  ...
  if(validator.isEmpty(description_ko)) {
    errors.description_ko =  "Please don't keep it blank";
  }
  if(validator.isEmpty(description_en)) {
    errors.description_en =  "Please don't keep it blank";
  }
...
export default validateEditPackage;