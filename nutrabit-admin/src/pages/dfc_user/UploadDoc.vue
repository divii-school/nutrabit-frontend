                ...
                <div class="p-col-12">
                    ...
                    <div class="p-grid p-formgrid p-mb-3">
                        ...
                        <div class="p-col-12 p-mb-2 p-lg-3 p-mb-lg-0 p-field">
                            <label for="subtitle2">
                                {{ $t('upload-doc.upload') }}
                                <span class="img-info" style="color: #17a2b8">(File type: jpg,png,hwp,docs,pdf,xls )</span>
                            </label>
...
export default {
    ...
    methods: {
        ...
        onFileChange(e) {
            ...
            var allowedExtensions = /(\.jpg|\.png|\.hwp|\.docs|\.pdf|\.xls)$/i;
            ...
            this.$confirm.require({
                ...
                accept: () => {
                    ...
                    if (isInvalid) {
                        ...
                        return axios.post('/dfc-admin/user/documents/upload', this.formData).then(() => {
