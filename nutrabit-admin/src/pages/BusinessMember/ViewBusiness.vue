    ...
    <div class="p-grid">
        ...
        <div class="p-col-12">
            <div class="card p-fluid">
                <h4><strong>{{$t('Business.list.Businessheader')}}</strong></h4>

                <div class="p-field p-grid">
					<label for="nameuser" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('Business.list.BusinessNumber') }}:</label>
                ...
                <div class="p-field p-grid">
					<label for="business_name" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('Business.list.BusinessName') }}:</label>
					<div class="p-col-12 p-md-10">
                ...
                <div class="p-field p-grid">
					<label for="department" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('Business.list.Departmentname') }}:</label>
					<div class="p-col-12 p-md-10">
                ...
                <div class="p-field p-grid">
					<label for="person_in_charge" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('Business.list.Personincharge') }}:</label>
					<div class="p-col-12 p-md-10">
                ...
                <div class="p-field p-grid">
					<label for="uuid" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('Business.list.ID') }}:</label>
					<div class="p-col-12 p-md-10">
						<p >{{ mydata.uuid }}</p>
					</div> 
				</div>
                ...
                <div class="p-field p-grid">
					<label for="password" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('Business.list.Password') }}:</label>
					<div class="p-col-12 p-md-10" style="display: flex; justify-content: flex-start">
						<p >********</p>  
                        <a href="#" @click="open" class="p-button p-button-outlined p-button-sm p-mr-2 p-mb-2" style=" background: white;border: 1px solid #0A0A0A;color: #000000; margin-left: 1%;">{{$t('Change Password')}}</a>
					</div>
				</div>
               
               
                <div class="p-field p-grid">
					<label for="email" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('Business.list.Email') }}:</label>
					<div class="p-col-12 p-md-10">
						<p >{{ mydata.email }}</p>
					</div> 
				</div>
                ...
                <div class="p-field p-grid">
					<label for="mobile" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('Business.list.mobile') }}:</label>
					<div class="p-col-12 p-md-10">
						<p >{{ mydata.mobile }}</p>
					</div> 
				</div>
                ...
                <div class="p-field p-grid">
					<label for="address" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('Business.list.Area') }}:</label>
					<div class="p-col-12 p-md-10">
						<p >{{ mydata.address }}</p>
					</div> 
				</div>
                ...
                <div class="p-field p-grid">
					<label for="createdDate" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('Business.list.RegistrationDate') }}:</label>
					<div class="p-col-12 p-md-10">
                ...
                <div class="p-d-flex p-jc-end" style="float:left;">
                    ...
                    <Button @click="del($route.params.id)" label="delete" class="p-button p-button-outlined p-button-sm p-mr-2 p-mb-2"><i class="pi pi-trash p-mr-2"></i> {{ $t('button.delete') }}</Button>
                </div>
            </div>
        </div>
         <Dialog :header="$t('Individual.list.changepass')" v-model:visible="display" :breakpoints="{ '960px': '75vw' }" :style="{ width: '30vw' }" :modal="true">
            ...
            <template #footer>
                <Button :label="$t('Individual.list.confirm')" @click="resetpass" class="p-button" style="background:white;color:black;border:0px solid; margin-right:60px;"/>
                <Button :label="$t('Individual.list.cancel')" @click="close" class="p-button"  style="float:left; background:white;color:black;border:0px solid;margin-left:60px;"/>
            </template>
        </Dialog>
    </div>
</template>
