...
const validateCreateRaw = (data) => {
  ...
  const {  material_name_ko, material_name_en,tag_ko,tag_en} = data;
  // if(validator.isEmpty(category_id)) {
  //   errors.category_id =  "카테고리를 선택하세요";
  // }
  // if(validator.isEmpty(sub_category_id)) {
  //   errors.sub_category_id =  "하위 카테고리 ID는 필수 항목입니다";
  // }
  ...
  //   errors.material_description_en =  "재료 전치 EN는 필수 항목입니다.";
  // }
