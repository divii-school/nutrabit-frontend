    ...
    <div class="p-grid">
        ...
        <div class="p-col-12">
            <div class="card p-fluid">
                <h4><strong>{{$t('RawMaterialadd.list.viewRawHeader')}}</strong></h4>
                 <div class="p-field p-grid">
					<label for="category_name_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.categorylist') }}:</label>
                 ...
                 <div class="p-field p-grid">
					<label for="material_name_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.Rawname(KO)') }}:</label>
					<div class="p-col-12 p-md-10">
                 ...
                 <div class="p-field p-grid">
					<label for="material_name_en" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.Rawname(EN)') }}:</label>
					<div class="p-col-12 p-md-10">
                ...
                <div class="p-field p-grid">
					<label for="standard_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.Standard(KO)') }}:</label>
					<div class="p-col-12 p-md-10">
						<p >{{ standard_ko }}</p>
					</div> 
				</div>
                 ...
                 <div class="p-field p-grid">
					<label for="standard_en" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.Standard(EN)') }}:</label>
					<div class="p-col-12 p-md-10">
						<p >{{ standard_en }}</p>
					</div> 
				</div>
                ...
                <div class="p-field p-grid">
					<label for="material_description_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.Rawmarterialdescription(KO)') }}:</label>
					<div class="p-col-12 p-md-10">
                ...
                <div class="p-field p-grid">
					<label for="material_description_en" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.Rawmarterialdescription(EN)') }}:</label>
					<div class="p-col-12 p-md-10">
                 ...
                 <div class="p-field p-grid">
					<label for="material_function_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.Function(KO)') }}:</label>
					<div class="p-col-12 p-md-10">
                 ...
                 <div class="p-field p-grid">
					<label for="material_function_en" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.Fucntion(EN)') }}:</label>
					<div class="p-col-12 p-md-10">
                ...
                <div class="p-field p-grid">
					<label for="daily_intake_amount_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.DailyIntakeAmount(KO)') }}:</label>
					<div class="p-col-12 p-md-10">
                 ...
                 <div class="p-field p-grid">
					<label for="daily_intake_amount_en" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.DailyIntakeAmount(EN)') }}:</label>
					<div class="p-col-12 p-md-10">
               ...
               <div class="p-field p-grid">
					<label for="material_prequotion_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.Prequotion(KO)') }}:</label>
					<div class="p-col-12 p-md-10">
                ...
                <div class="p-field p-grid">
					<label for="material_prequotion_en" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.Prequotion(EN)') }}:</label>
					<div class="p-col-12 p-md-10">
                 ...
                 <div class="p-field p-grid">
					<label for="material_extra_info_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.Extrainfo(KO)') }}:</label>
					<div class="p-col-12 p-md-10">
                ...
                <div class="p-field p-grid">
					<label for="material_extra_info_en" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.Extrainfo(EN)') }}:</label>
					<div class="p-col-12 p-md-10">
                ...
                <div class="p-field p-grid">
					...
					<div class="p-col-12 p-md-10" v-for="(similar_product_img,img) in similar_product_img" :key="img" >
                 ...
                 <div class="p-field p-grid">
					...
					<div class="p-col-12 p-md-10" v-for="(raw_material_img,img) in raw_material_img" :key="img">
                ...
                <div class="p-field p-grid">
					<label for="tag_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.tags(KO)') }}:</label>
					<div class="p-col-12 p-md-10" >
                ...
                <div class="p-field p-grid">
					<label for="tag_en" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.tags(EN)') }}:</label>
					<div class="p-col-12 p-md-10" >
                ...
                <div class="p-field p-grid">
					<label for="status" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">{{ $t('RawMaterialadd.list.status') }}:</label>
					<div class="p-col-12 p-md-10" >
