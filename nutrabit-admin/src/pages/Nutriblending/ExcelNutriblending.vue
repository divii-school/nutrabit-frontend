        ...
        <form>
            <div class="p-grid p-fluid">
                <div class="p-col-12">
                    ...
                    <div class="sample">
                          <a href="https://back.nutri33.co.kr/public/sample_file/recommended_blending.xlsx" target="_blank" class="p-button p-button-text p-mr-2 p-mb-2">Sample Download </a>
                    </div>
